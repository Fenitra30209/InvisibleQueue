  ...
  return (
    ...
    >
      ...
      <TouchableOpacity onPress={() => router.replace('/')}>
        <Text style={styles.guestLink}>Continuer en invité →</Text>
      </TouchableOpacity>
    </KeyboardAvoidingView>
  )
}
...
const styles = StyleSheet.create({
  container: {
    flex: 1, justifyContent: 'center', padding: 28, backgroundColor: '#f8fafc',
  },
  ...
  guestLink: { color: '#94a3b8', textAlign: 'center', marginTop: 12, fontSize: 14 },
})